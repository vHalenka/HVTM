...
animals = np.array([2, 3])

training_pool_size = 5000
ensembles = 2
epochs = 80
...
Y_train = Y_train.reshape(Y_train.shape[0])[0:training_pool_size]
Y_test = Y_test.reshape(Y_test.shape[0])[0:training_pool_size]
...
np.load("training_processed.npz", X_train=X_train, X_test=X_test, Y_train=Y_train, Y_test=Y_test)
